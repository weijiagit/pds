...
public class JSONUtils {
    ...
    public static PlanResult result(String code, String msg, Object data, Long totalRecordNumber) {
        PlanResult planResult = new PlanResult();
        planResult.setCode(code);
        planResult.setMsg(msg);
        planResult.setData(data);
        planResult.setTotalRecordNumber(totalRecordNumber);
        return planResult;
    }

    public static PlanResult result(String code, String msg, Object data) {
        PlanResult planResult = new PlanResult();
        planResult.setCode(code);
        planResult.setMsg(msg);
        planResult.setData(data);
    ...
    public static PlanResult result(String code, String msg, Object data, String taskFlag) {
        PlanResult planResult = new PlanResult();
        planResult.setCode(code);
        planResult.setMsg(msg);
        planResult.setData(data);
        planResult.setTaskFlag(taskFlag);
        return planResult;
    }
