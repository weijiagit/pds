...
public class HttpUtil {
    ...
    public static JSONObject get(String url, Map<String, String> params) throws IOException, JSONException {
    ...
    public static JSONObject post(String url, String jsonValue) throws IOException , JSONException {
        JSONObject json = new JSONObject();
        HttpClient client = new HttpClient();
    ...
    public static JSONObject postForWeiXin(String url,String jsonValue) throws IOException , JSONException{
        JSONObject json = new JSONObject();
        HttpClient client = new HttpClient();
        PostMethod postMethod=new PostMethod(url);
        //设置超时时长
