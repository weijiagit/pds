package com.fykj.util.http.loader;
...
import com.fykj.util.http.annotation.PropertyConfigiration;
import com.fykj.util.http.annotation.Value;
import com.fykj.util.http.utils.PropertiesUtils;
